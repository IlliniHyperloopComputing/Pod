...
if(not do_compare):
    ...
    for i in range(0, len(use)):
        if(not dual):
            f, (ax2, ax3, ax4) = plt.subplots(3,1, sharex=True, figsize = (20,10))
