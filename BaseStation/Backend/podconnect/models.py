...
class MotionData(models.Model):
    ...
    motor_state = models.IntegerField()
    brake_state = models.IntegerField()
    motor_target_torque = models.IntegerField()
    relay_state_buff_0 = models.CharField()
    relay_state_buff_1 = models.CharField()
    relay_state_buff_2 = models.CharField()
    relay_state_buff_3 = models.CharField()

class ADCData(models.Model):
    date_time = models.DateTimeField(auto_now=True,primary_key=True)
    data_0 = models.IntegerField()
    data_1 = models.IntegerField()
    data_2 = models.IntegerField()
    data_3 = models.IntegerField()
    data_4 = models.IntegerField()
    data_5 = models.IntegerField()
    data_6 = models.IntegerField()
