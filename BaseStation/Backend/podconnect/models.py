...
class MotionData(models.Model):
    ...
    p_timeout = models.IntegerField(default=0)
    a_timeout = models.IntegerField(default=0)
    c_timeout = models.IntegerField(default=0)
    b_timeout = models.IntegerField(default=0)
    p_counter = models.IntegerField(default=0)
    a_counter = models.IntegerField(default=0)
    c_counter = models.IntegerField(default=0)
    b_counter = models.IntegerField(default=0)
