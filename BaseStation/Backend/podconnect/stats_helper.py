...
def getRanges():
    toRet = {}
    toRet["State_Number"] = [0, 7]
    toRet["Status_Word"] = [0, 7]
    toRet["Position_Val"] = [0, 1]
    toRet["Torque_Val"] = [0, 1]
    toRet["Controller_Temp"] = [0, 1]
    toRet["Motor_Temp"] = [0, 1]
    toRet["DC_Link_Voltage"] = [0, 1]
    toRet["Logic_Power_Supply_Voltage"] = [0, 1]
    toRet["Current_Demand"] = [0, 1]
    toRet["Motor_Current_Val"] = [0, 1]
    toRet["Electrical_Angle"] = [0, 1]
    toRet["Phase_A_Current"] = [0, 1]
    toRet["Phase_B_Current"] = [0, 1]
    toRet["Accel_1 x"] = [0, 1]
    toRet["Accel_1 y"] = [0, 1]
    toRet["Accel_1 z"] = [0, 1]
    toRet["Accel_2 x"] = [0, 1]
    toRet["Accel_2 y"] = [0, 1]
    toRet["Accel_2 z"] = [0, 1]
    toRet["Internal_Relay_State"] = [0, 1]
    toRet["Relay_State"] = [0, 1]
    toRet["Rolling_Counter"] = [0, 1]
    toRet["Fail_Safe_State"] = [0, 1]
    toRet["Peak_Current"] = [0, 1]
    toRet["Pack_Voltage_Inst"] = [0, 1]
    toRet["Pack_Voltage_Open"] = [0, 1]
    toRet["Pack_SOC"] = [0, 1]
    toRet["Pack_Amphours"] = [0, 1]
    toRet["Pack_Resistance"] = [0, 1]
    toRet["Pack_DOD"] = [0, 1]
    toRet["Pack_SOH"] = [0, 1]
    toRet["Current_Limit_Status"] = [0, 1]
    toRet["Max_Pack_DCL"] = [0, 1]
    toRet["Motor_State"] = [0, 1]
    toRet["Brake_State"] = [0, 1]
    toRet["Motor_Target_Torque"] = [0, 1]
    toRet["Pre-Charge Relay Status"] = [0, 1]
    toRet["LV Relay Status"] = [0, 1]
    toRet["HV Relay Status"] = [0, 1]
    toRet["Relay State Buff 3"] = [0, 1]
    toRet["Avg_Pack_Current"] = [0, 1]
    toRet["Highest_Temp"] = [0, 1]
    toRet["Highest_Temp_ID"] = [0, 1]
    toRet["Avg_Temp"] = [0, 1]
    toRet["Internal_Temp"] = [0, 1]
    toRet["Low_Cell_Voltage"] = [0, 1]
    toRet["Low_Cell_Voltage_ID"] = [0, 1]
    toRet["High_Cell_Voltage"] = [0, 1]
    toRet["High_Cell_Voltage_ID"] = [0, 1]
    toRet["Low_Cell_InternalR"] = [0, 1]
    toRet["Low_Cell_InternalR_ID"] = [0, 1]
    toRet["High_Cell_InternalR"] = [0, 1]
    toRet["High_Cell_InternalR_ID"] = [0, 1]
    toRet["Power_Voltage_Input"] = [0, 1]
    toRet["DTC_Status_One"] = [0, 1]
    toRet["DTC_Status_Two"] = [0, 1]
    toRet["Adaptive_Total_Cap"] = [0, 1]
    toRet["Adaptive_Amphours"] = [0, 1]
    toRet["Adaptive_SOC"] = [0, 1]
    toRet["ADCError"] = [0, 1]
    toRet["CANError"] = [0, 1]
    toRet["I2CError"] = [0, 1]
    toRet["PRUError"] = [0, 1]
    toRet["NetworkError"] = [0, 1]
    toRet["OtherError"] = [0, 1]
    toRet["I2C 0x48 0"] = [0, 1]
    toRet["I2C 0x48 1"] = [0, 1]
    toRet["I2C 0x48 2"] = [0, 1]
    toRet["I2C 0x48 3"] = [0, 1]
    toRet["Orange Distance"] = [0, 1]
    toRet["Orange Velocity"] = [0, 1]
    toRet["Wheel Distance"] = [0, 1]
    toRet["Wheel Velocity"] = [0, 1]
    toRet["Acceleration"] = [0, 1]
    toRet["Pre-Charge counter"] = [0, 1]
    toRet["Pre-Charge timeout"] = [0, 1]
    toRet["Acceleration counter"] = [0, 1]
    toRet["Acceleration timeout"] = [0, 1]
    toRet["Coast counter"] = [0, 1]
    toRet["Coast timeout"] = [0, 1]
    toRet["Brake counter"] = [0, 1]
    toRet["Brake timeout"] = [0, 1]
