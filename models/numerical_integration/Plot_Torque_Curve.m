...
function [] = Plot_Torque_Curve ()
    ...
    hold on;
    plot(poly_96_x, poly_96_y, ':', 'color', 'g');
    plot(poly_95_x, poly_95_y, ':', 'color', 'b');
    plot(poly_94_x, poly_94_y, ':', 'color', 'm');
    plot(poly_90_x, poly_90_y, ':', 'color', 'k');
    plot(poly_86_x, poly_86_y, ':', 'color', 'r');
