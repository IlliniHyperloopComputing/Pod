...
#===============
  ...
  Begin_single_con= 0x8000;
  Device_mode_single = 0x100;
  Device_mode_continuous = 0x000;
  Last_5 = 0x03;#bits[4:0] that we are not planning on changing
  ...
  #No error checking because your smart
    config = self.Begin_single_con | self. Device_mode_single | self.ain.get(ain) | self.data_rate.get(data_rate)| self.gain.get(gain) | self.Last_5
